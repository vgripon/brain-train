...
def get_ssl_transform(image_size, supervised_transform, normalization=DEFAULT_NORMALIZATION):
    ...
    for step in all_steps:
        if 'dino' in step:
            all_transforms['dino'] = DINOAugmentation(image_size, normalization=normalization, local_crops_number=DEFAULT_NCROPS, global_crops_scale=(0.5,1), local_crops_scale=(0.05, 0.4))
