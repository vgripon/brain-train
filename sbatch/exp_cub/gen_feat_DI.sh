...
python ../../main.py --dataset-path /gpfs/users/a1881717/datasets/ \
  ...
  --load-backbone /gpfs/users/a1881717/exp_cub_vs_air/backbones/${dat}/backbones_2birds \
  --epoch 1 --save-features-prefix /gpfs/users/a1881717/exp_cub_vs_air/features/${dat}/f2birds_finetuned --backbone resnet12 \
