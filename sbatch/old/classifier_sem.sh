...
python ../main.py --dataset-path /gpfs/users/a1881717/datasets/  \
 --load-backbone /gpfs/users/a1881717/resnet12_metadataset_imagenet_64.pt \
  --subset-file /gpfs/users/a1881717/work_dir/binary_agnostic_sem4.npy \
  ...
  --save-classifier /gpfs/users/a1881717/work_dir/sem4/classifiers/classifier_$SLURM_ARRAY_TASK_ID \
