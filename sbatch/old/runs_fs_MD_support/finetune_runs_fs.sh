...
python ../../main.py \
  ...
  --support-file /gpfs/users/a1881717/brain-train/finetuning/magnitudes_test/magnitude_MD_test_${dat}.pt \
  --index-subset ${index} \
  --training-dataset metadataset_${dat}_test \
  --epoch 20 --dataset-size 10000 --wd 0.0001 --lr 0.001  \
  --load-classifier /gpfs/users/a1881717/MD_work_dir/support/classifiers/${dat}/classifier_${index} \
  --scheduler cosine --backbone resnet12 --batch-size 128 --few-shot-shots 0 --few-shot-ways 0 --few-shot-queries 0 --few-shot  \
  --save-backbone /gpfs/users/a1881717/MD_work_dir/support/backbones/${dat}/backbones_${index} \
  --save-classifier /gpfs/users/a1881717/MD_work_dir/support/classifiers/${dat}/classifier_finetune_${index} \
  $@
