...
python ../../main.py --dataset-path /gpfs/users/a1881717/datasets/ \
  ...
  --load-backbone /gpfs/users/a1881717/5shots_work_dir/support_direct_5s5w/backbones/${dat}/backbones_${index} \
  --epoch 1 --save-features-prefix /gpfs/users/a1881717/5shots_work_dir/support_direct_5s5w/features/${dat}/$index --backbone resnet12
  $@
else
python ../../main.py --dataset-path /gpfs/users/a1881717/datasets/ \
