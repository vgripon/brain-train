...
python ../../main.py \
  ...
  --load-classifier /gpfs/users/a1881717/MD_work_dir/test/classifiers/${dat}/classifier_${index} \
  --scheduler cosine --backbone resnet12 --batch-size 128 --few-shot-shots 0 --few-shot-ways 0 --few-shot-queries 0 --few-shot  \
  --save-backbone /gpfs/users/a1881717/MD_work_dir/test/backbones/${dat}/backbones_${index} \
  --save-classifier /gpfs/users/a1881717/MD_work_dir/test/classifiers/${dat}/classifier_finetune_${index} \
  $@
