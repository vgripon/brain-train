...
python ../../main.py --dataset-path /gpfs/users/a1881717/datasets/ \
  ...
  --load-backbone /gpfs/users/a1881717/MD_work_dir/runs_fs/backbones/${dat}/backbones2_$index \
  --epoch 1 --save-features-prefix /gpfs/users/a1881717/MD_work_dir/runs_fs/features/${dat}/2_$index --backbone resnet12 \
