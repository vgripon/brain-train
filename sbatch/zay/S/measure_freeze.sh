...
save_stats="${WORK}/results/S/measure/${mode}/${dat}/freeze_${SLURM_ARRAY_TASK_ID}.json"

load_backbone="${WORK}/resnet12_metadataset_imagenet_64.pt"

load_classifier_base="${WORK}/results/S/${mode}/classifiers/${dat}/"
load_classifier="${load_classifier_base}/classifier_finetune_freeze_${SLURM_ARRAY_TASK_ID}"
