...
save_backbone="${save_backbone_base}/backbones_${lr}"
save_classifier="${save_classifier_base}/classifier_finetune_${lr}"
load_classifier="${save_classifier_base}/classifier"
