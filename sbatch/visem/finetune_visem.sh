...
python ../../main.py --dataset-path /gpfs/users/a1881717/datasets/  \
 --few-shot --few-shot-shots 0 --few-shot-runs 10000 --few-shot --few-shot-ways 0 \
  --load-backbone /gpfs/users/a1881717/resnet12_metadataset_imagenet_64.pt \
   --subset-file /gpfs/users/a1881717/work_dir/binary_agnostic_visem.npy --index-subset $SLURM_ARRAY_TASK_ID \
   --training-dataset metadataset_imagenet_train --epoch 20 --dataset-size 10000 --wd 0.0001 --lr 0.001  \
   --load-classifier /gpfs/users/a1881717/work_dir/visem/classifiers/classifier_$SLURM_ARRAY_TASK_ID \
   --backbone resnet12 --batch-size 128 --few-shot-shots 0 --few-shot-ways 0 --few-shot-queries 0 \
   --few-shot  --save-backbone /gpfs/users/a1881717/work_dir/visem/backbones/backbone_$SLURM_ARRAY_TASK_ID  \
   --save-classifier /gpfs/users/a1881717/work_dir/visem/classifiers/classifier_finetune_$SLURM_ARRAY_TASK_ID
