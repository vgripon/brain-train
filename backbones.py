...
def prepareBackbone():
    ...
    return {
        ...
        "vit_small_32": lambda: (ViT(image_size = 224, patch_size = 32, channels = 3, dim_head=64, dim = 768, depth = 12, heads = 12, mlp_dim = 3072), 768),
        "vit_small_16": lambda: (ViT(image_size = 224, patch_size = 16, channels = 3, dim_head=64, dim = 768, depth = 12, heads = 12, mlp_dim = 3072), 768),
        "vit_large_32": lambda: (ViT(image_size = 224, patch_size = 32, channels = 3, dim_head=64, dim = 1024, depth = 24, heads = 16, mlp_dim = 4096), 1024),
        "vit_large_16": lambda: (ViT(image_size = 224, patch_size = 16, channels = 3, dim_head=64, dim = 1024, depth = 24, heads = 16, mlp_dim = 4096), 1024),
        "vit_huge_14": lambda: (ViT(image_size = 224, patch_size = 32, channels = 3, dim_head=64, dim = 1280, depth = 32, heads = 16, mlp_dim = 5120), 1280)
        }[args.backbone.lower()]()
