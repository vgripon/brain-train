...
def prepareBackbone():
    ...
    return {
        ...
        "vit_tiny_32": lambda: (ViT(image_size = args.image_size, patch_size = 32, channels = 3, dim_head=64, dim = 192, depth = 12, heads = 3, mlp_dim = 192*4, pool=False, projection='conv'), 192),
        "vit_tiny_16": lambda: (ViT(image_size = args.image_size, patch_size = 16, channels = 3, dim_head=64, dim = 192, depth = 12, heads = 3, mlp_dim = 192*4, pool=False, projection='conv'), 192),
        "vit_small_32": lambda: (ViT(image_size = args.image_size, patch_size = 32, channels = 3, dim_head=64, dim = 384, depth = 12, heads = 6, mlp_dim = 384*4, pool=False, projection='conv'), 384),
        "vit_small_16": lambda: (ViT(image_size = args.image_size, patch_size = 16, channels = 3, dim_head=64, dim = 384, depth = 12, heads = 6, mlp_dim = 384*4, pool=False, projection='conv'), 384),
        "vit_base_32": lambda: (ViT(image_size = args.image_size, patch_size = 32, channels = 3, dim_head=64, dim = 768, depth = 12, heads = 12, mlp_dim = 768*4, pool=False, projection='conv'), 768),
        "vit_base_16": lambda: (ViT(image_size = args.image_size, patch_size = 16, channels = 3, dim_head=64, dim = 768, depth = 12, heads = 12, mlp_dim = 768*4, pool=False, projection='conv'), 768),
        "vit_large_32": lambda: (ViT(image_size = args.image_size, patch_size = 32, channels = 3, dim_head=64, dim = 1024, depth = 24, heads = 16, mlp_dim = 1024*4, pool=False, projection='conv'), 1024),
        "vit_large_16": lambda: (ViT(image_size = args.image_size, patch_size = 16, channels = 3, dim_head=64, dim = 1024, depth = 24, heads = 16, mlp_dim = 1024*4, pool=False, projection='conv'), 1024),
        "vit_huge_14": lambda: (ViT(image_size = args.image_size, patch_size = 32, channels = 3, dim_head=64, dim = 1280, depth = 32, heads = 16, mlp_dim = 1280*4, pool=False, projection='conv'), 1280)
        }[args.backbone.lower()]()
