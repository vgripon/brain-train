...
class SIMCLRAugmentation(object):
    def __init__(self,
        ...
        # first view
        self.global_transform1 = transforms.Compose([rrc_flip_color_distort_blur, normalization])
        # second view
        self.global_transform2 = transforms.Compose([rrc_flip_color_distort_blur, normalization])
