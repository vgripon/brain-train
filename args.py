...
parser.add_argument("--task-file", type=str, default='', help="binary npy file with index clusters of classes in imagenet")
parser.add_argument("--task-queries", action="store_true", help="load the quesries instead of the shots")
...
parser.add_argument("--save-stats", type=str, default='', help="split on which the subset file is applied.")
...
parser.add_argument("--index-episode", type=str, default='', help="index in binary npy file with index of cluster or episode of classes in imagenet")
