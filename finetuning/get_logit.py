...
if sl12:
    ...
    for dataset in  ['cub', 'aircraft', 'dtd', 'mscoco', 'fungi', 'omniglot', 'vgg_flower']:
        os.system('python main.py --dataset-path /users2/libre/datasets/  --epoch 1 --validation-dataset metadataset_{0}_validation  --freeze-backbone --freeze-classifier --load-classifier /users2/libre/raphael/classifier_metadataset_imagenet_64.pt --load-backbone /users2/libre/raphael/resnet12_metadataset_imagenet_64.pt --save-logits /users2/libre/raphael/logits_{0}_val.pt --backbone resnet12'.format(dataset))
    dataset = 'traffic_signs'
    os.system('python main.py --dataset-path /users2/libre/datasets/  --epoch 1 --test-dataset metadataset_{0}_validation  --freeze-backbone --freeze-classifier --load-classifier /users2/libre/raphael/classifier_metadataset_imagenet_64.pt --load-backbone /users2/libre/raphael/resnet12_metadataset_imagenet_64.pt --save-logits /users2/libre/raphael/logits_{0}_val.pt --backbone resnet12'.format(dataset))
    ...
    for dataset in ['cub', 'aircraft', 'dtd', 'mscoco', 'fungi', 'omniglot',  'vgg_flower']:
        os.system('python main.py --dataset-path /home/datasets/ --epoch 1 --training-dataset metadataset_imagenet_train --validation-dataset metadataset_{0}_validation  --freeze-backbone --freeze-classifier --load-classifier /home/raphael/Documents/models/classifier_metadataset_imagenet_64.pt --load-backbone /home/raphael/Documents/models/resnet12_metadataset_imagenet_64.pt --save-logits /home/raphael/Documents/models/old_logits/logits_{0}_val.pt --backbone resnet12'.format(dataset))
    dataset = 'traffic_signs'
    os.system('python main.py --dataset-path /home/datasets/ --epoch 1 --training-dataset metadataset_imagenet_train --test-dataset metadataset_{0}_test  --freeze-backbone --freeze-classifier --load-classifier /home/raphael/Documents/models/classifier_metadataset_imagenet_64.pt --load-backbone /home/raphael/Documents/models/resnet12_metadataset_imagenet_64.pt --save-logits /home/raphael/Documents/models/old_logits/logits_{0}_test.pt --backbone resnet12'.format(dataset))