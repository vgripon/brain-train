...
#get_classifier
os.system( prefix + ' --freeze-backbone --force-train --epochs 30 --lr 0.1   --save-classifier {0}finetune_cubc4_classifier{1}.pt  {2} --batch-size 128 --save-features-prefix {0}baseline{1}'.format(dir1, key, suffix))
