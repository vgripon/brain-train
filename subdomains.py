...
os.system('python create_dataset_files.py --dataset-path /users2/libre/datasets/ --subdomain ~/Documents/clean-train/notebooks/imagenet_subbackbones/data/'+str(N)+'clusters.npy')
