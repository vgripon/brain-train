...
python ../main.py --dataset-path /hpcfs/users/a1881717/datasets/   --load-backbone /hpcfs/users/a1881717/backbones/resnet12_metadataset_imagenet_64.pt  --subset-file /hpcfs/users/a1881717/work_dir/binary_agnostic_vis.npy --index-subset $SLURM_ARRAY_TASK_ID --training-dataset metadataset_imagenet_train --epoch 10 --dataset-size 10000 --wd 0.0001 --lr 0.001 --freeze-backbone --load-classifier /hpcfs/users/a1881717/work_dir/vis/classifiers/classifier_$SLURM_ARRAY_TASK_ID --scheduler linear --force-train --backbone resnet12 --batch-size 128 --few-shot-shots 0 --few-shot-ways 0 --few-shot-queries 0 --few-shot --save-features-prefix /hpcfs/users/a1881717/work_dir/vis/features/feat_$SLURM_ARRAY_TASK_ID --save-backbone /hpcfs/users/a1881717/work_dir/vis/backbones/backbone_$SLURM_ARRAY_TASK_ID
